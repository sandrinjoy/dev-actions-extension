...
export default function Popup(): JSX.Element {
  ...
  function handleSortTabs(){
    ...
    chrome.runtime.sendMessage({type: BACKGROUND_TASKS.SORT_TABS});
  }
  return (
    ...
    <div className='flex gap-4 jsutify-center items-center'>
     ...
     <button onClick={handleRestartChrome} className='rounded-full bg-red-400 aspect-square h-10 flex items-center justify-center'>
